...
if ($result->num_rows > 0) {
    ...
    echo "<h1 align=center style=color:#4CAF50;> Electronics and Communication Engineering-2023</h1>";
    echo "<table border='1' align=center>";
    echo "<tr>
            <th>Name</th><th>Roll No</th><th>GRADUATED YEAR</th><th>DATE</th><th>PROGRAM OF STUDY</th><th>BRANCH</th>
            <td style='text-align:center;'>p1</td><td style='text-align:center;'>p2</td><td style='text-align:center;'>p3</td>
            <td style='text-align:center;'>p4</td><td style='text-align:center;'>p5</td><td style='text-align:center;'>p6</td>
            <td style='text-align:center;'>p7</td><td style='text-align:center;'>p8</td>
            <th>occupation</th>
            <td style='text-align:center;'>po1</td><td style='text-align:center;'>po2</td><td style='text-align:center;'>po3</td>
            <td style='text-align:center;'>po4</td><td style='text-align:center;'>po5</td><td style='text-align:center;'>po6</td>
            <td style='text-align:center;'>po7</td><td style='text-align:center;'>po8</td>
            <td style='text-align:center;'>po9</td><td style='text-align:center;'>po10</td>
            <td style='text-align:center;'>po11</td><td style='text-align:center;'>po12</td>
            <td style='text-align:center;'>pso1</td><td style='text-align:center;'>pso2</td>
            <th>feedback</th>
          </tr>";
